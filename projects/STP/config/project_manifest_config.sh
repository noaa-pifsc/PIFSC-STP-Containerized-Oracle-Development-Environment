#!/bin/bash
	...
	DB_SCRIPTS_MAP+=("${BUILD_PATH}/../../projects/STP/modules/STP/SQL|@dev_container_setup/create_docker_schemas.sql|oracle_admin_user|oracle_pwd|stp_db_password|stp_app_db_password|stp_apx_username|stp_apx_password")

	# create TEMPL_PROJ schema objects
	DB_SCRIPTS_MAP+=("${BUILD_PATH}/../../projects/STP/modules/STP/SQL|@automated_deployments/deploy_dev_container.sql|stp_db_username|stp_db_password")

	# create TEMPL_PROJ_APP schema objects
	DB_SCRIPTS_MAP+=("${BUILD_PATH}/../../projects/STP/modules/STP/SQL|@automated_deployments/deploy_apex_dev.sql|stp_app_db_username|stp_app_db_password")
