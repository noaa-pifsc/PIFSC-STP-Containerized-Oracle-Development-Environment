...
##### Container Configuration Variables: #####
	...
	APP_SCHEMA_NAME=TEMPL_PROJ

##### Project Configuration Variables: #####

	# define the container git project URL
	GIT_URL="--branch Branch_CODE_v1.4_install git@github.com:noaa-pifsc/PIFSC-STP-Containerized-Oracle-Development-Environment.git"